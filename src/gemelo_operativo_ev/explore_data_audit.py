...
def _detect_issues(tables: dict[str, pd.DataFrame]) -> pd.DataFrame:
    ...
    add_issue(
        ...
        "critical",
        salida_no_ready,
        "No debe haber salida real anterior a timestamp_readiness",
        "Introducir bloqueo estricto hasta readiness o una excepción operativa trazable.",
    )
    ...
    add_issue(
        ...
        "medium",
        delay_no_cause,
        "Retraso material (>120 min) requiere causa de retraso válida",
