...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generador sintético industrial para gemelo operativo de transición EV."
    )
    ...
    parser.add_argument(
        ...
        help="Directorio de salida raw EV dedicado",
    )
    parser.add_argument(
        "--output-reports",
        type=str,
        default="outputs/reports",
        help="Directorio de reportes de validación",
    )
...
def main() -> None:
    ...
    print(f"- estado validación: {summary['validation']['status_global']}")
